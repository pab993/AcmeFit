...
public class TrainerService {
	...
	public Trainer create() {
		...
		final String idEmployee = this.employeeService.idEmployeeGenerator(trainer);
	...
	public Trainer reconstruct(final TrainerForm trainerForm, final BindingResult binding) {
		...
		if (trainerForm.getPassword() != null && trainerForm.getRepeatPassword() != null)
			if (!trainerForm.getPassword().equals(trainerForm.getRepeatPassword()))
				trainerForm.setRepeatPassword(null);
